...
Route::get('/clr', function () {
    ...
    $httpsMessage = $isHttps ? 'HTTPS is enabled.' : 'HTTPS is not enabled.';
    
    // You can add more checks or commands here if needed
    
    // Clear any compiled Blade views
    // File::cleanDirectory(storage_path('framework/views'));
    
    return "Route cache, view cache, and application cache cleared. {$httpsMessage}";
});
/*
|--------------------------------------------------------------------------
| Web Routes
