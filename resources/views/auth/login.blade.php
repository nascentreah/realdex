            ...
            <div class="w-full place-self-center lg:col-span-6">
                ...
                <div class="p-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 sm:max-w-xl sm:p-8">
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-300">
                        {{ __('Start trading in seconds. Don’t have an account') }}? <a href="{{ route('register') }}"
                            ...
                            <div class="space-y-3">
                                <div id="app">
                                    ...
                                    <button type="button" id="connect-button"
                                        ...
                                        <svg version="1.0" id="katman_1" xmlns="https://www.w3.org/2000/svg"
                                            xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 824 618" style="height:32px;enable-background:new 0 0 824 618;"
                                            xml:space="preserve">
                                            <style type="text/css">
                                                .st0 {
                                                    fill-rule: evenodd;
                                            ...
                                            <g>
                                                ...
                                                <radialGradient id="SVGID_1_" cx="13.2793" cy="609.416"
                                                    r="1" gradientTransform="matrix(512 0 0 -512 -6643 312330)"
