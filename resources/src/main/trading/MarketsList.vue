      ...
      <a
        ...
        @click="
          filter != 1
            ...
            : (filter = 2)
        "
        ><span class="mr-1">{{ $t("Market") }}</span>
        <div class="flex flex-col" style="font-size: 8px;">
          <i
            class="bi"
            style="line-height: 0px !important;"
            :class="
              filter == 1 ? 'text-warning bi-caret-up-fill' : 'bi-caret-up'
            "
          ></i>
          <i
            class="bi"
            style="line-height: 0px !important;"
            :class="
              filter == 2 ? 'text-warning bi-caret-down-fill' : 'bi-caret-down'
            "
          ></i>
        </div>
      </a>
      <a
        ...
        <div class="flex flex-col" style="font-size: 8px;">
          <i
            ...
            style="line-height: 0px !important;"
            :class="
              filter == 5 ? 'text-warning bi-caret-up-fill' : 'bi-caret-up'
            "
          ></i>
          <i
            class="bi"
            style="line-height: 0px !important;"
            :class="
              filter == 6 ? 'text-warning bi-caret-down-fill' : 'bi-caret-down'
            "
          ></i>
        </div>
      </a>
      <a
        ...
        <div class="flex flex-col" style="font-size: 8px;">
          <i
            ...
            style="line-height: 0px !important;"
            :class="
              filter == 3 ? 'text-warning bi-caret-up-fill' : 'bi-caret-up'
            "
          ></i>
          <i
            class="bi"
            style="line-height: 0px !important;"
            :class="
              filter == 4 ? 'text-warning bi-caret-down-fill' : 'bi-caret-down'
            "
          ></i>
        </div>
      </a>
        ...
        <div>
          ...
          >
            <span class="text-dark fw-bold"
              >{{ item.currency ?? item.base }}/</span
            ><span class="text-secondary fw-bold">{{
              item.pair ?? item.quote
            }}</span>
          </router-link>
        </div>
        <span class="text-end" :class="item.classChange">{{
          priceFormatter(item.change, 3) || ""
        }}</span>
        <span class="text-end mr-1" :class="item.class">{{
  ...
  export default {
    ...
    methods: {
      priceFormatter(p, maxDigits = 8, d = ",") {
        ...
        decimalCount = Math.min(Math.max(decimalCount, 0), 8);
